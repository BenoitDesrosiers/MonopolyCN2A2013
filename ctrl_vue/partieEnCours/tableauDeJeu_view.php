	    			...
	    			if ($case == null) :?>
						...
						<?php if($i == 11):?>
							<td id="centre"colspan="9" rowspan="9">
								<svg x="0px" y="0px" width="700px" height="700px" xmlns="http://www.w3.org/2000/svg" version="1.1">
  									...
  									<text x="150" y="430" width="100" height="150" style="fill:white; stroke:black; font-size:52px;"transform="rotate(310 150,150)">MONOPOLY</text>
						...
						<?php $case = $tableauDeJeu->getCaseParPosition($i);
	    					...
	    					if ($case == null) :?>
			    				<td class="caseCote">
									<svg width="100px" height="75px" xmlns="http://www.w3.org/2000/svg" version="1.1">
									<text class="titreP" x="38px" y="15px" transform="rotate(270 38,35)">
										Case action</text>
								</svg>
								</td> 
	    					<?php else :
	    					if($case->getType() == "servicePublic" || $case->getType() =="train") :?>
		    						<td class="caseCote">
				    					<svg width="100px" height="75px" xmlns="http://www.w3.org/2000/svg" version="1.1">
											...
											<text class="montant" x="38px" y="90px" transform="rotate(270 38,35)"><?php echo $case->getPrix();?> $</text>
										</svg>
									</td>
								<?php else :?>
				    				<td class="caseCote">
