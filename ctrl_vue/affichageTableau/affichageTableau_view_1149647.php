					...
					<td 
						<?php if ($currentPosition == 0 || $currentPosition == 10) : ?>
							...
							<svg width="100px" height="100px" width="100px" height="100px" xmlns="http://www.w3.org/2000/svg" version="1.1">
								<text x="38px" y="40px" transform="rotate(180 50,50)"> case action
						<?php elseif ($tableauDeJeu->getCaseByPosition($currentPosition) == null) : ?>
							class = "verticalCase">
							<svg width="75px" height="100px" xmlns="http://www.w3.org/2000/svg" version="1.1">
								<text x="38px" y="10px" transform="rotate(180 38,50)"> case action
						<?php else : ?>
							class = "verticalCase">
							<svg width="75px" height="100px" xmlns="http://www.w3.org/2000/svg" version="1.1">
				...
				<tr>
					<td class="horizontalCase">	
						<svg width="100px" height="75px" xmlns="http://www.w3.org/2000/svg" version="1.1">
							<?php if ($tableauDeJeu->getCaseByPosition(50 - $currentPosition) == null) : ?> 
					...
					<?php if ($currentPosition == 11) : ?>
						<td colspan="9" rowspan="9" class="centerCase"> <p> Monopoly </p> </td>
					<?php endif; ?>
					<td class="horizontalCase">	
						<svg width="100px" height="75px" xmlns="http://www.w3.org/2000/svg" version="1.1">
							<?php if ($tableauDeJeu->getCaseByPosition($currentPosition) == null) : ?> 
			...
			<tr>
				<?php while ($currentPosition <= 30) : ?>
					<td 
						...
						<?php elseif ($tableauDeJeu->getCaseByPosition(20 + (30 - $currentPosition)) == null) : ?>
							class = "verticalCase">
							<svg width="75px" height="100px" xmlns="http://www.w3.org/2000/svg" version="1.1">
						...
						<?php else : ?>
							class = "verticalCase">
							<svg width="75px" height="100px" xmlns="http://www.w3.org/2000/svg" version="1.1">
								<rect x="0" y="0" width="75" height="30" style="fill: <?php echo $tableauDeJeu->getCaseByPosition(20 + (30 - $currentPosition))->getCouleurHTML(); ?>;stroke:rgb(0,0,0);" />
								<text x="38px" y="45px"> 
								<?php	$caseName =  $tableauDeJeu->getCaseByPosition(20 + (30 - $currentPosition))->getNom();
										$lastSpaceIndex = 0;
										$spaceCounter = 0;
										if (strlen($caseName) > $maxTextLength) : 
											while(strpos(substr($caseName, $lastSpaceIndex + 1), ' ') != false && $spaceCounter < 3) :
									...
									<?php	endif;
											...
											echo $tableauDeJeu->getCaseByPosition(20 + (30 - $currentPosition))->getNom();
										endif; 
								?>
								</text>
								<text x="38px" y="95px"> <?php echo $tableauDeJeu->getCaseByPosition(20 + (30 - $currentPosition))->getPrix(); ?> $
						<?php endif; ?>
							</text>
						</svg>
					</td>
