...
class Joueur extends Objet  implements EntreposageDatabase{
    ...
    */
	...
	public function brasseDes() {
		...
		//FIXME: on fait quoi quand y'a un double? faudrait mettre la partie dans un �tat permettant � ce joueur de rejouer
    ...
    public function paye($montant) {
        ...
        if($argentCtr < $montant){
        	throw new Excception("Le jouer n'a pas assé d'argent");
	...
	public function getListeCartes() {
		...
		$this->listeCartes = array_merge($cartesChance, $cartesCC);
